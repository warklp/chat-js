  ...
  return (
    <section className="border-border/30 border-y py-12">
      <div className="mx-auto max-w-6xl px-6">
        <p className="text-center text-muted-foreground text-sm uppercase tracking-wide">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-x-14 gap-y-4">
          {PROVIDERS.map((name) => (
            <span
              className="font-medium text-foreground/60 text-xl tracking-tight transition-colors hover:text-foreground/80"
              key={name}
            >
              {name}
            </span>
