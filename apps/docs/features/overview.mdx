...
<CardGroup cols={2}>
  ...
  <Card title="Parallel Responses" icon="split" href="/features/parallel-responses">
    Send one message to multiple models at once and compare their answers side by side.
  </Card>
  <Card title="Follow-up Suggestions" icon="messages-square" href="/features/follow-up-suggestions">
